...
export const statusesApi = {
  ...
  create: (data: { name: string; code: string; description?: string; color?: string; is_active?: boolean; can_be_referred?: boolean; is_closure_status?: boolean; is_default_status?: boolean }, token?: AuthToken) => 
    apiRequest<{ success: boolean; data: any; message: string }>('/statuses', {
      method: 'POST',
      body: JSON.stringify(data),
    }, token),
  update: (id: number, data: { name?: string; code?: string; description?: string; color?: string; is_active?: boolean; can_be_referred?: boolean; is_closure_status?: boolean; is_default_status?: boolean }, token?: AuthToken) => 
...
export const mockStatuses: Status[] = [
  { id: 1, name: 'Active', code: 'active', description: 'Property is available for sale/rent', color: '#10B981', is_active: true, can_be_referred: true, is_closure_status: false, is_default_status: true, created_at: '2025-01-01T00:00:00Z', updated_at: '2025-01-01T00:00:00Z' },
  { id: 2, name: 'Sold', code: 'sold', description: 'Property has been sold', color: '#EF4444', is_active: true, can_be_referred: false, is_closure_status: true, is_default_status: false, created_at: '2025-01-01T00:00:00Z', updated_at: '2025-01-01T00:00:00Z' },
  { id: 3, name: 'Rented', code: 'rented', description: 'Property has been rented', color: '#8B5CF6', is_active: true, can_be_referred: false, is_closure_status: true, is_default_status: false, created_at: '2025-01-01T00:00:00Z', updated_at: '2025-01-01T00:00:00Z' },
  { id: 4, name: 'Under Contract', code: 'under_contract', description: 'Property is under contract', color: '#F59E0B', is_active: true, can_be_referred: true, is_closure_status: false, is_default_status: false, created_at: '2025-01-01T00:00:00Z', updated_at: '2025-01-01T00:00:00Z' },
  { id: 5, name: 'Pending', code: 'pending', description: 'Property is pending approval', color: '#3B82F6', is_active: true, can_be_referred: true, is_closure_status: false, is_default_status: false, created_at: '2025-01-01T00:00:00Z', updated_at: '2025-01-01T00:00:00Z' }
]
