...
export function ReferralSelector({
  ...
  const addReferral = (e: React.MouseEvent) => {
    ...
    if (newReferral.name && newReferral.date) {
      console.log('Adding referral with date:', newReferral.date); // Debug log
            ...
            <div className="p-3 border-b border-gray-200 bg-blue-50">
              <div className="space-y-3">
                ...
                <div className="flex space-x-2">
                  <button
                    type="button"
                    onClick={() => setNewReferral(prev => ({ ...prev, type: 'employee' }))}
                  ...
                  <button
                    type="button"
                    onClick={() => setNewReferral(prev => ({ ...prev, type: 'custom' }))}
                    className={`px-3 py-1 text-xs rounded-full transition-colors ${
