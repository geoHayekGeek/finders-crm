...
interface ReferPropertyModalProps {
  isOpen: boolean
  onClose: () => void
...
export function ReferPropertyModal({
  isOpen,
  onClose,
  property,
  onSuccess
}: ReferPropertyModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        const errorMessage = data.message || 'An unexpected error occurred while referring the property. Please try again.'
        ...
        <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full">
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200  sticky top-0 bg-white z-1">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-xl font-semibold text-gray-900">Refer Property</h2>
                <p className="text-sm text-gray-500">Refer this property to an agent or team leader</p>
              </div>
            </div>
            <button
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="flex items-center justify-end space-x-3">
              ...
              >
                {loading ? 'Referring...' : 'Refer Property'}
              </button>
            </div>
          </form>
        </div>
