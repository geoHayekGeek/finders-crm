 ...
 * This groups team leaders and assigned agents together so the Excel export can
 * render a single detailed table on the left and keep the operations table on the right.
 * @param {Date|string} startDateInput
 * @param {Date|string} endDateInput
 * @returns {Promise<object>}
 */
