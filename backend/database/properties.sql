...
-- Format: F + PropertyType + Category + Year + GlobalUniqueID
-- Example: FRIW251 (Finders Rent Industrial Warehouse 2025, ID=1 globally unique)
-- The ID is globally unique across ALL properties, no leading zeros
