-- Migration: Add property closing referral commission fields
-- Adds separate commission fields for the latest property referral, latest lead referral,
-- and an optional list of external referral commissions.
