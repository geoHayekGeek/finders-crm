-- Add an explicit closure flag for property statuses.
-- This becomes the source of truth for closed-property behavior in CRUD flows and reports.
...
'Indicates whether this status closes the property. Used for closed_date behavior, reporting, and commissions.';
