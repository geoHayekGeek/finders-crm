...
async function ensureClosedStatus() {
  ...
  const inserted = await pool.query(
    `
      INSERT INTO statuses (name, code, description, color, is_active, can_be_referred, is_closure_status, is_default_status)
      VALUES ('Closed', 'closed', 'Property is closed (sold or rented)', '#6B7280', TRUE, FALSE, TRUE, FALSE)
