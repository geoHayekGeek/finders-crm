// Migration runner script for updating reference number function to use globally unique IDs
const fs = require('fs');
...
async function runMigration() {
  try {
    console.log('🚀 Starting reference number function migration (globally unique IDs)...');
    
    // Read the migration file
    const migrationPath = path.join(__dirname, 'database', 'migrations', 'update_reference_number_global_unique_final.sql');
    ...
    console.log('📊 The generate_reference_number function has been updated to use globally unique IDs');
